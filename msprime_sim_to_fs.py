import msprime, argparse, sys, numpy as np
import pandas as pd
import math
...
parser.add_argument(
	"-out", help="Path and filename to save the tree sequence", required=True, 
	#"-path", help='Path to save finestructure files to', required=True
	)
...
dd = msprime.DemographyDebugger(population_configurations=population_configurations,migration_matrix=migration_matrix,demographic_events=demographic_events)
dd.print_history()
...
tree_sequence.dump(path="/Users/williambarrie/Desktop/msprime_model/"+args.out) #Saving tree.sequence object to desired directory
