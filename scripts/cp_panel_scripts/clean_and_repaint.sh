...
to_paint = list()
for i in range(1,23):
    painted = pd.read_csv("temp."+str(i)+".counts", sep=" ", header=None, on_bad_lines='skip')[[5,6]]
...
for i in range(1,23):
  dummy=pd.read_csv("temp." + str(i) + ".master_all_copyprobsperlocus.txt", header=None, on_bad_lines='skip')
...
chunkcounts = pd.read_csv("ordered_all_pop_ids_mapped.allchr.chunkcounts.out", header=None, sep=" ", on_bad_lines='skip', dtype = str)
...
chunklengths = pd.read_csv("ordered_all_pop_ids_mapped.allchr.chunklengths.out", header=None, sep=" ", on_bad_lines='skip', dtype = str)
...
regionchunkcounts = pd.read_csv("ordered_all_pop_ids_mapped.allchr.regionchunkcounts.out", header=None, sep=" ", on_bad_lines='skip', dtype = str)
...
regionsquaredchunkcounts = pd.read_csv("ordered_all_pop_ids_mapped.allchr.regionsquaredchunkcounts.out", header=None, sep=" ", eon_bad_lines='skip', dtype = str)
...
mutationprobs = pd.read_csv("ordered_all_pop_ids_mapped.allchr.mutationprobs.out", header=None, sep=" ", on_bad_lines='skip', dtype = str)
...
for i in range(1,23):
  chunkcounts = pd.read_csv("perchrom_results/ordered_all_pop_ids_mapped.chr"+str(i)+".chunkcounts.out", header=None, sep=" ", on_bad_lines='skip', dtype = str)
  chunkcounts = chunkcounts[~chunkcounts[0].isin(to_paint)]
  chunkcounts.to_csv("perchrom_results/ordered_all_pop_ids_mapped.chr"+str(i)+".chunkcounts.out", sep=" ", header=False, index=False)
  chunklengths = pd.read_csv("perchrom_results/ordered_all_pop_ids_mapped.chr"+str(i)+".chunklengths.out", header=None, sep=" ", on_bad_lines='skip', dtype = str)
  chunklengths = chunklengths[~chunklengths[0].isin(to_paint)]
  chunklengths.to_csv("perchrom_results/ordered_all_pop_ids_mapped.chr"+str(i)+".chunklengths.out", sep=" ", header=False, index=False)
  regionchunkcounts = pd.read_csv("perchrom_results/ordered_all_pop_ids_mapped.chr"+str(i)+".regionchunkcounts.out", header=None, sep=" ", on_bad_lines='skip', dtype = str)
  regionchunkcounts = regionchunkcounts[~regionchunkcounts[0].isin(to_paint)]
  ...
  regionsquaredchunkcounts = pd.read_csv("perchrom_results/ordered_all_pop_ids_mapped.chr"+str(i)+".regionsquaredchunkcounts.out", header=None, sep=" ", on_bad_lines='skip', dtype = str)
  regionsquaredchunkcounts = regionsquaredchunkcounts[~regionsquaredchunkcounts[0].isin(to_paint)]
  ...
  mutationprobs = pd.read_csv("perchrom_results/ordered_all_pop_ids_mapped.chr"+str(i)+".mutationprobs.out", header=None, sep=" ", on_bad_lines='skip', dtype = str)
  mutationprobs = mutationprobs[~mutationprobs[0].isin(to_paint)]
