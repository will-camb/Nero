...
## Extract data
	myecho "ReferencePhase: $refpanelphase ReferenceRec: $refpanelrecomb IndNum: $indnum"
	cmd="fs cp -n $refpanelne -M $refpanelmu -g $refpanelphase -r $refpanelrecomb -f $refpaneldonor $indnum $indnum -t $dir/$refpanelname/rerun.chr$chr.ids -o $dir/$refpanelname/cp/rerun.chr$chr -s 0"
